...
export const TUTORIAL_STEPS = [
  ...
  // ==========================================
  {
    ...
    targetKey: 'cup_stack',
    sourceCoords: { x: 450, y: 298, width: 54, height: 41 },
    destinationCoords: { x: 351, y: 488, width: 314, height: 359 },
    targetCoords: { x: 450, y: 298, width: 54, height: 41 },
  ...
  },
  {
    ...
    targetCoords: { x: 275, y: 386, width: 82, height: 65 },
  ...
  },
  {
    ...
    targetKey: 'btn_milk',
    targetCoords: { x: 380, y: 386, width: 82, height: 65 },
