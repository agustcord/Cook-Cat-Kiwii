...
* **Solución**:
  ...
  3. Se creó una pila interactiva de tazas vacías apoyada físicamente en la superficie superior ("techo") de la cafetera (`startY - 68`) simulando una cafetera real. Para maximizar la limpieza visual de la UI, se removieron las etiquetas de texto `'TAZAS'` y `'CAFETERÍA'`. Al presionar la pila de tazas, una de ellas cae con un tween fluido hasta colocarse en el dispensador inferior.
