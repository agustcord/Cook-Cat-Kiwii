...
export const DEFAULT_TARGET_BOUNDS = {
  ...
  cup_stack: { x: 450, y: 298, width: 54, height: 41, radius: 16 },
  btn_coffee: { x: 275, y: 386, width: 82, height: 65, radius: 16 },
  btn_milk: { x: 380, y: 386, width: 82, height: 65, radius: 16 },
  drink_machine: { x: 351, y: 488, width: 314, height: 359, radius: 24 },
  drink_cup: { x: 351, y: 589, width: 70, height: 60, radius: 16 },
